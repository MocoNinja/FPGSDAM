...
while($linea=mysql_fetch_array($registros))
{
	echo"<div class='product'><img src='$linea[imagen]' width ='172'><div class='text'><p class='product_title'>$linea[nombre]</p><p class='price'>$linea[precio]</p><div class='buy'><a href='altasCarrito.php?ref=$linea[idProducto]'><img src='./img/cart_add.png'></a></div></div></div>";
}
?>			
