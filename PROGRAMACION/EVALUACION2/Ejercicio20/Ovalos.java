...
public class Ovalos extends Rectangle{
	static final int ANCHO = 20, ALTO = 10;
	static Color[] colores = {Color.MAGENTA, Color.CYAN, Color.YELLOW};
	...
	public void mueve(Rectangle ovalo)
	{
		if (x > MAX_X || x < MIN_X)
		{
			xAcc *= -1;
